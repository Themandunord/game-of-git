...
/**
 * String identifier used to categorize a GitHub Webhook Event. The value can be used as a discriminator, ultimately, to distinguish the corresponding event model from the raw object.
 */
export type GitHubWebhookEventTypes =
	| CheckRun
	| CheckSuite
	| CommitComment
	| ContentReference
