...
const PULL_REQUEST_REVIEW_COMMENT_ACTION: { [key: string]: PullRequestReviewCommentActionType } = {
...
export type PullRequestReviewCommentActionType = 'created' | 'edited' | 'deleted';
