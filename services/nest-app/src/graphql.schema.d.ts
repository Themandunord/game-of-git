...
export enum GitHubBranchOrderByInput {
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    name_ASC = "name_ASC",
    name_DESC = "name_DESC",
...
export enum GitHubCommentOrderByInput {
    bodyText_ASC = "bodyText_ASC",
    bodyText_DESC = "bodyText_DESC",
...
export enum GitHubCommitOrderByInput {
    additions_ASC = "additions_ASC",
    additions_DESC = "additions_DESC",
    authedDate_ASC = "authedDate_ASC",
    authedDate_DESC = "authedDate_DESC",
    changedFiles_ASC = "changedFiles_ASC",
    changedFiles_DESC = "changedFiles_DESC",
    commitUrl_ASC = "commitUrl_ASC",
    commitUrl_DESC = "commitUrl_DESC",
    deletions_ASC = "deletions_ASC",
    deletions_DESC = "deletions_DESC",
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    message_ASC = "message_ASC",
    message_DESC = "message_DESC",
    messageHeadline_ASC = "messageHeadline_ASC",
    messageHeadline_DESC = "messageHeadline_DESC",
    pushedDate_ASC = "pushedDate_ASC",
    pushedDate_DESC = "pushedDate_DESC",
    treeUrl_ASC = "treeUrl_ASC",
    treeUrl_DESC = "treeUrl_DESC",
    url_ASC = "url_ASC",
    url_DESC = "url_DESC",
    createdAt_ASC = "createdAt_ASC",
    createdAt_DESC = "createdAt_DESC",
...
export enum GitHubFileDiffOrderByInput {
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    additions_ASC = "additions_ASC",
    additions_DESC = "additions_DESC",
    deletions_ASC = "deletions_ASC",
    deletions_DESC = "deletions_DESC",
    filepath_ASC = "filepath_ASC",
    filepath_DESC = "filepath_DESC",
    createdAt_ASC = "createdAt_ASC",
    createdAt_DESC = "createdAt_DESC",
    updatedAt_ASC = "updatedAt_ASC",
    updatedAt_DESC = "updatedAt_DESC"
...
export enum GitHubIssueOrderByInput {
    ...
    createdAtExternal_ASC = "createdAtExternal_ASC",
    createdAtExternal_DESC = "createdAtExternal_DESC",
    lastEditedAt_ASC = "lastEditedAt_ASC",
    lastEditedAt_DESC = "lastEditedAt_DESC",
...
export enum GitHubLabelOrderByInput {
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    color_ASC = "color_ASC",
...
export enum GitHubPullRequestOrderByInput {
    additions_ASC = "additions_ASC",
    additions_DESC = "additions_DESC",
    bodyText_ASC = "bodyText_ASC",
    bodyText_DESC = "bodyText_DESC",
    ...
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    isCrossRepository_ASC = "isCrossRepository_ASC",
    isCrossRepository_DESC = "isCrossRepository_DESC",
    locked_ASC = "locked_ASC",
    locked_DESC = "locked_DESC",
    merged_ASC = "merged_ASC",
    merged_DESC = "merged_DESC",
...
export enum GitHubPullRequestReviewOrderByInput {
    bodyText_ASC = "bodyText_ASC",
    bodyText_DESC = "bodyText_DESC",
    createdAtExternal_ASC = "createdAtExternal_ASC",
    createdAtExternal_DESC = "createdAtExternal_DESC",
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    lastEditeddAt_ASC = "lastEditeddAt_ASC",
    lastEditeddAt_DESC = "lastEditeddAt_DESC",
    publishedAt_ASC = "publishedAt_ASC",
    publishedAt_DESC = "publishedAt_DESC",
    state_ASC = "state_ASC",
    state_DESC = "state_DESC",
...
export enum GitHubRepositoryOrderByInput {
    description_ASC = "description_ASC",
    description_DESC = "description_DESC",
    hasBranchRules_ASC = "hasBranchRules_ASC",
    hasBranchRules_DESC = "hasBranchRules_DESC",
    hasContributingGuidelines_ASC = "hasContributingGuidelines_ASC",
    hasContributingGuidelines_DESC = "hasContributingGuidelines_DESC",
    hasPullRequestTemplate_ASC = "hasPullRequestTemplate_ASC",
    hasPullRequestTemplate_DESC = "hasPullRequestTemplate_DESC",
    hasReadMe_ASC = "hasReadMe_ASC",
    hasReadMe_DESC = "hasReadMe_DESC",
    hasWiki_ASC = "hasWiki_ASC",
    hasWiki_DESC = "hasWiki_DESC",
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
...
export enum GitHubReviewRequestOrderByInput {
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    createdAt_ASC = "createdAt_ASC",
    createdAt_DESC = "createdAt_DESC",
...
export enum GitHubReviewThreadOrderByInput {
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    isResolved_ASC = "isResolved_ASC",
    isResolved_DESC = "isResolved_DESC",
    createdAt_ASC = "createdAt_ASC",
    createdAt_DESC = "createdAt_DESC",
    updatedAt_ASC = "updatedAt_ASC",
    updatedAt_DESC = "updatedAt_DESC"
...
export enum GitHubTopicOrderByInput {
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    name_ASC = "name_ASC",
    name_DESC = "name_DESC",
...
export enum GitHubUserOrderByInput {
    id_ASC = "id_ASC",
    id_DESC = "id_DESC",
    url_ASC = "url_ASC",
    url_DESC = "url_DESC",
    ...
    isBountyHunter_ASC = "isBountyHunter_ASC",
    isBountyHunter_DESC = "isBountyHunter_DESC",
    isCampusExpert_ASC = "isCampusExpert_ASC",
    isCampusExpert_DESC = "isCampusExpert_DESC",
    isDeveloperProgramMember_ASC = "isDeveloperProgramMember_ASC",
    isDeveloperProgramMember_DESC = "isDeveloperProgramMember_DESC",
    isEmployee_ASC = "isEmployee_ASC",
    isEmployee_DESC = "isEmployee_DESC",
    isHireable_ASC = "isHireable_ASC",
    isHireable_DESC = "isHireable_DESC",
    isSiteAdmin_ASC = "isSiteAdmin_ASC",
    isSiteAdmin_DESC = "isSiteAdmin_DESC",
    isViewer_ASC = "isViewer_ASC",
    isViewer_DESC = "isViewer_DESC",
    createdAt_ASC = "createdAt_ASC",
    createdAt_DESC = "createdAt_DESC",
    updatedAt_ASC = "updatedAt_ASC",
    updatedAt_DESC = "updatedAt_DESC"
...
export class GitHubBranchCreateInput {
    id?: string;
    name: string;
    merged?: boolean;
...
export class GitHubBranchSubscriptionWhereInput {
...
export class GitHubBranchUpdateInput {
    name?: string;
    merged?: boolean;
...
export class GitHubBranchUpdateManyMutationInput {
    name?: string;
    merged?: boolean;
}

export class GitHubBranchWhereInput {
...
export class GitHubBranchWhereUniqueInput {
    id?: string;
}

export class GitHubCommentCreateInput {
    bodyText: string;
...
export class GitHubCommentCreateManyInput {
    create?: GitHubCommentCreateInput[];
    connect?: GitHubCommentWhereUniqueInput[];
}

export class GitHubCommentScalarWhereInput {
...
export class GitHubCommentSubscriptionWhereInput {
...
export class GitHubCommentUpdateDataInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    url?: string;
...
export class GitHubCommentUpdateInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    url?: string;
    author?: GitHubUserUpdateOneRequiredInput;
...
export class GitHubCommentUpdateManyDataInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    url?: string;
}

export class GitHubCommentUpdateManyInput {
    create?: GitHubCommentCreateInput[];
    connect?: GitHubCommentWhereUniqueInput[];
...
export class GitHubCommentUpdateManyMutationInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    url?: string;
}

export class GitHubCommentUpdateManyWithWhereNestedInput {
    where: GitHubCommentScalarWhereInput;
    data: GitHubCommentUpdateManyDataInput;
}

export class GitHubCommentUpdateWithWhereUniqueNestedInput {
    where: GitHubCommentWhereUniqueInput;
    data: GitHubCommentUpdateDataInput;
}

export class GitHubCommentUpsertWithWhereUniqueNestedInput {
    where: GitHubCommentWhereUniqueInput;
    update: GitHubCommentUpdateDataInput;
    create: GitHubCommentCreateInput;
}

export class GitHubCommentWhereInput {
...
export class GitHubCommentWhereUniqueInput {
    id?: string;
}

export class GitHubCommitCreateInput {
    additions: number;
    authedDate: DateTime;
    changedFiles: number;
    commitUrl: string;
...
export class GitHubCommitCreateManyInput {
    create?: GitHubCommitCreateInput[];
    connect?: GitHubCommitWhereUniqueInput[];
}

export class GitHubCommitScalarWhereInput {
    AND?: GitHubCommitScalarWhereInput[];
    OR?: GitHubCommitScalarWhereInput[];
    NOT?: GitHubCommitScalarWhereInput[];
    additions?: number;
    additions_not?: number;
    additions_in?: number[];
    additions_not_in?: number[];
    additions_lt?: number;
    additions_lte?: number;
    additions_gt?: number;
    additions_gte?: number;
    authedDate?: DateTime;
    ...
    changedFiles?: number;
    changedFiles_not?: number;
    changedFiles_in?: number[];
    changedFiles_not_in?: number[];
    changedFiles_lt?: number;
    changedFiles_lte?: number;
    changedFiles_gt?: number;
    changedFiles_gte?: number;
    commitUrl?: string;
    ...
    deletions?: number;
    deletions_not?: number;
    deletions_in?: number[];
    deletions_not_in?: number[];
    deletions_lt?: number;
    deletions_lte?: number;
    deletions_gt?: number;
    deletions_gte?: number;
    id?: string;
    id_not?: string;
    id_in?: string[];
    id_not_in?: string[];
...
export class GitHubCommitSubscriptionWhereInput {
...
export class GitHubCommitUpdateDataInput {
    additions?: number;
    authedDate?: DateTime;
    changedFiles?: number;
    commitUrl?: string;
...
export class GitHubCommitUpdateInput {
    additions?: number;
    authedDate?: DateTime;
    changedFiles?: number;
    commitUrl?: string;
...
export class GitHubCommitUpdateManyDataInput {
    additions?: number;
    authedDate?: DateTime;
    changedFiles?: number;
    commitUrl?: string;
...
export class GitHubCommitUpdateManyInput {
    create?: GitHubCommitCreateInput[];
    connect?: GitHubCommitWhereUniqueInput[];
...
export class GitHubCommitUpdateManyMutationInput {
    additions?: number;
    authedDate?: DateTime;
    changedFiles?: number;
    commitUrl?: string;
...
export class GitHubCommitUpdateManyWithWhereNestedInput {
    where: GitHubCommitScalarWhereInput;
    data: GitHubCommitUpdateManyDataInput;
}

export class GitHubCommitUpdateWithWhereUniqueNestedInput {
    where: GitHubCommitWhereUniqueInput;
    data: GitHubCommitUpdateDataInput;
}

export class GitHubCommitUpsertWithWhereUniqueNestedInput {
    where: GitHubCommitWhereUniqueInput;
    update: GitHubCommitUpdateDataInput;
    create: GitHubCommitCreateInput;
}

export class GitHubCommitWhereInput {
...
export class GitHubCommitWhereUniqueInput {
    id?: string;
}

export class GitHubFileDiffCreateInput {
    id?: string;
    additions: number;
    deletions: number;
    filepath: string;
...
export class GitHubFileDiffCreateManyInput {
    create?: GitHubFileDiffCreateInput[];
    connect?: GitHubFileDiffWhereUniqueInput[];
}

export class GitHubFileDiffScalarWhereInput {
...
export class GitHubFileDiffSubscriptionWhereInput {
...
export class GitHubFileDiffUpdateDataInput {
    additions?: number;
    deletions?: number;
    filepath?: string;
}

export class GitHubFileDiffUpdateInput {
    additions?: number;
    deletions?: number;
    filepath?: string;
}

export class GitHubFileDiffUpdateManyDataInput {
    additions?: number;
    deletions?: number;
    filepath?: string;
}

export class GitHubFileDiffUpdateManyInput {
    create?: GitHubFileDiffCreateInput[];
    connect?: GitHubFileDiffWhereUniqueInput[];
...
export class GitHubFileDiffUpdateManyMutationInput {
    additions?: number;
    deletions?: number;
    filepath?: string;
}

export class GitHubFileDiffUpdateManyWithWhereNestedInput {
    where: GitHubFileDiffScalarWhereInput;
    data: GitHubFileDiffUpdateManyDataInput;
}

export class GitHubFileDiffUpdateWithWhereUniqueNestedInput {
    where: GitHubFileDiffWhereUniqueInput;
    data: GitHubFileDiffUpdateDataInput;
}

export class GitHubFileDiffUpsertWithWhereUniqueNestedInput {
    where: GitHubFileDiffWhereUniqueInput;
    update: GitHubFileDiffUpdateDataInput;
    create: GitHubFileDiffCreateInput;
}

export class GitHubFileDiffWhereInput {
...
export class GitHubFileDiffWhereUniqueInput {
    id?: string;
}

export class GitHubIssueCreateInput {
    id?: string;
    bodyText: string;
    closed?: DateTime;
    createdAtExternal: DateTime;
...
export class GitHubIssueCreateManyInput {
    create?: GitHubIssueCreateInput[];
    connect?: GitHubIssueWhereUniqueInput[];
}

export class GitHubIssueScalarWhereInput {
...
export class GitHubIssueSubscriptionWhereInput {
...
export class GitHubIssueUpdateDataInput {
    bodyText?: string;
    closed?: DateTime;
    createdAtExternal?: DateTime;
    lastEditedAt?: DateTime;
...
export class GitHubIssueUpdateInput {
    bodyText?: string;
    closed?: DateTime;
    createdAtExternal?: DateTime;
    lastEditedAt?: DateTime;
...
export class GitHubIssueUpdateManyDataInput {
    bodyText?: string;
    closed?: DateTime;
    createdAtExternal?: DateTime;
    lastEditedAt?: DateTime;
...
export class GitHubIssueUpdateManyInput {
    create?: GitHubIssueCreateInput[];
    connect?: GitHubIssueWhereUniqueInput[];
...
export class GitHubIssueUpdateManyMutationInput {
    bodyText?: string;
    closed?: DateTime;
    createdAtExternal?: DateTime;
    lastEditedAt?: DateTime;
...
export class GitHubIssueUpdateManyWithWhereNestedInput {
    where: GitHubIssueScalarWhereInput;
    data: GitHubIssueUpdateManyDataInput;
}

export class GitHubIssueUpdateWithWhereUniqueNestedInput {
    where: GitHubIssueWhereUniqueInput;
    data: GitHubIssueUpdateDataInput;
}

export class GitHubIssueUpsertWithWhereUniqueNestedInput {
    where: GitHubIssueWhereUniqueInput;
    update: GitHubIssueUpdateDataInput;
    create: GitHubIssueCreateInput;
}

export class GitHubIssueWhereInput {
...
export class GitHubIssueWhereUniqueInput {
    id?: string;
}

export class GitHubLabelCreateInput {
    id?: string;
    color: string;
    createdAtExternal: DateTime;
    description: string;
...
export class GitHubLabelCreateManyInput {
    create?: GitHubLabelCreateInput[];
    connect?: GitHubLabelWhereUniqueInput[];
}

export class GitHubLabelScalarWhereInput {
...
export class GitHubLabelSubscriptionWhereInput {
...
export class GitHubLabelUpdateDataInput {
    color?: string;
    createdAtExternal?: DateTime;
    description?: string;
    name?: string;
...
export class GitHubLabelUpdateInput {
    color?: string;
    createdAtExternal?: DateTime;
    description?: string;
    name?: string;
...
export class GitHubLabelUpdateManyDataInput {
    color?: string;
    createdAtExternal?: DateTime;
    description?: string;
    name?: string;
...
export class GitHubLabelUpdateManyInput {
    create?: GitHubLabelCreateInput[];
    connect?: GitHubLabelWhereUniqueInput[];
...
export class GitHubLabelUpdateManyMutationInput {
    color?: string;
    createdAtExternal?: DateTime;
    description?: string;
    name?: string;
...
export class GitHubLabelUpdateManyWithWhereNestedInput {
    where: GitHubLabelScalarWhereInput;
    data: GitHubLabelUpdateManyDataInput;
}

export class GitHubLabelUpdateWithWhereUniqueNestedInput {
    where: GitHubLabelWhereUniqueInput;
    data: GitHubLabelUpdateDataInput;
}

export class GitHubLabelUpsertWithWhereUniqueNestedInput {
    where: GitHubLabelWhereUniqueInput;
    update: GitHubLabelUpdateDataInput;
    create: GitHubLabelCreateInput;
}

export class GitHubLabelWhereInput {
...
export class GitHubLabelWhereUniqueInput {
    id?: string;
}

export class GitHubPullRequestCreateInput {
    additions: number;
    bodyText: string;
    changedFiles: number;
    closed: boolean;
...
export class GitHubPullRequestCreateManyInput {
    create?: GitHubPullRequestCreateInput[];
    connect?: GitHubPullRequestWhereUniqueInput[];
}

export class GitHubPullRequestCreateOneInput {
    create?: GitHubPullRequestCreateInput;
    connect?: GitHubPullRequestWhereUniqueInput;
}

export class GitHubPullRequestReviewCreateInput {
    bodyText: string;
    createdAtExternal: DateTime;
    id?: string;
...
export class GitHubPullRequestReviewCreateManyInput {
    create?: GitHubPullRequestReviewCreateInput[];
    connect?: GitHubPullRequestReviewWhereUniqueInput[];
}

export class GitHubPullRequestReviewScalarWhereInput {
...
export class GitHubPullRequestReviewSubscriptionWhereInput {
...
export class GitHubPullRequestReviewUpdateDataInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    lastEditeddAt?: DateTime;
    publishedAt?: DateTime;
...
export class GitHubPullRequestReviewUpdateInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    lastEditeddAt?: DateTime;
    publishedAt?: DateTime;
...
export class GitHubPullRequestReviewUpdateManyDataInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    lastEditeddAt?: DateTime;
    publishedAt?: DateTime;
...
export class GitHubPullRequestReviewUpdateManyInput {
    create?: GitHubPullRequestReviewCreateInput[];
    connect?: GitHubPullRequestReviewWhereUniqueInput[];
...
export class GitHubPullRequestReviewUpdateManyMutationInput {
    bodyText?: string;
    createdAtExternal?: DateTime;
    lastEditeddAt?: DateTime;
    publishedAt?: DateTime;
...
export class GitHubPullRequestReviewUpdateManyWithWhereNestedInput {
    where: GitHubPullRequestReviewScalarWhereInput;
    data: GitHubPullRequestReviewUpdateManyDataInput;
}

export class GitHubPullRequestReviewUpdateWithWhereUniqueNestedInput {
    where: GitHubPullRequestReviewWhereUniqueInput;
    data: GitHubPullRequestReviewUpdateDataInput;
}

export class GitHubPullRequestReviewUpsertWithWhereUniqueNestedInput {
    where: GitHubPullRequestReviewWhereUniqueInput;
    update: GitHubPullRequestReviewUpdateDataInput;
    create: GitHubPullRequestReviewCreateInput;
}

export class GitHubPullRequestReviewWhereInput {
...
export class GitHubPullRequestReviewWhereUniqueInput {
    id?: string;
}

export class GitHubPullRequestScalarWhereInput {
...
export class GitHubPullRequestSubscriptionWhereInput {
...
export class GitHubPullRequestUpdateDataInput {
    additions?: number;
    bodyText?: string;
    changedFiles?: number;
    closed?: boolean;
...
export class GitHubPullRequestUpdateInput {
    additions?: number;
    bodyText?: string;
    changedFiles?: number;
    closed?: boolean;
...
export class GitHubPullRequestUpdateManyDataInput {
    additions?: number;
    bodyText?: string;
    changedFiles?: number;
    closed?: boolean;
...
export class GitHubPullRequestUpdateManyInput {
    create?: GitHubPullRequestCreateInput[];
    connect?: GitHubPullRequestWhereUniqueInput[];
...
export class GitHubPullRequestUpdateManyMutationInput {
    additions?: number;
    bodyText?: string;
    changedFiles?: number;
    closed?: boolean;
...
export class GitHubPullRequestUpdateManyWithWhereNestedInput {
    where: GitHubPullRequestScalarWhereInput;
    data: GitHubPullRequestUpdateManyDataInput;
}

export class GitHubPullRequestUpdateOneInput {
    create?: GitHubPullRequestCreateInput;
    connect?: GitHubPullRequestWhereUniqueInput;
    disconnect?: boolean;
    delete?: boolean;
...
export class GitHubPullRequestUpdateOneRequiredInput {
    create?: GitHubPullRequestCreateInput;
    connect?: GitHubPullRequestWhereUniqueInput;
    update?: GitHubPullRequestUpdateDataInput;
    upsert?: GitHubPullRequestUpsertNestedInput;
...
export class GitHubPullRequestUpdateWithWhereUniqueNestedInput {
    where: GitHubPullRequestWhereUniqueInput;
    data: GitHubPullRequestUpdateDataInput;
}

export class GitHubPullRequestUpsertNestedInput {
    update: GitHubPullRequestUpdateDataInput;
    create: GitHubPullRequestCreateInput;
}

export class GitHubPullRequestUpsertWithWhereUniqueNestedInput {
    where: GitHubPullRequestWhereUniqueInput;
    update: GitHubPullRequestUpdateDataInput;
    create: GitHubPullRequestCreateInput;
}

export class GitHubPullRequestWhereInput {
...
export class GitHubPullRequestWhereUniqueInput {
    id?: string;
}

export class GitHubRepositoryCreateInput {
    description: string;
...
export class GitHubRepositoryCreateOneInput {
    create?: GitHubRepositoryCreateInput;
    connect?: GitHubRepositoryWhereUniqueInput;
}

export class GitHubRepositorySubscriptionWhereInput {
...
export class GitHubRepositoryUpdateDataInput {
    description?: string;
    hasBranchRules?: boolean;
    hasContributingGuidelines?: boolean;
    hasPullRequestTemplate?: boolean;
...
export class GitHubRepositoryUpdateInput {
    description?: string;
    hasBranchRules?: boolean;
    hasContributingGuidelines?: boolean;
    hasPullRequestTemplate?: boolean;
...
export class GitHubRepositoryUpdateManyMutationInput {
    description?: string;
    hasBranchRules?: boolean;
    hasContributingGuidelines?: boolean;
    hasPullRequestTemplate?: boolean;
...
export class GitHubRepositoryUpdateOneRequiredInput {
    create?: GitHubRepositoryCreateInput;
    connect?: GitHubRepositoryWhereUniqueInput;
...
export class GitHubRepositoryUpsertNestedInput {
    update: GitHubRepositoryUpdateDataInput;
    create: GitHubRepositoryCreateInput;
}

export class GitHubRepositoryWhereInput {
...
export class GitHubRepositoryWhereUniqueInput {
    id?: string;
}

export class GitHubReviewRequestCreateInput {
    id?: string;
    pullRequest: GitHubPullRequestCreateOneInput;
    requestedReviewer: GitHubUserCreateOneInput;
}

export class GitHubReviewRequestCreateManyInput {
    create?: GitHubReviewRequestCreateInput[];
    connect?: GitHubReviewRequestWhereUniqueInput[];
}

export class GitHubReviewRequestScalarWhereInput {
...
export class GitHubReviewRequestSubscriptionWhereInput {
...
export class GitHubReviewRequestUpdateDataInput {
    pullRequest?: GitHubPullRequestUpdateOneRequiredInput;
    requestedReviewer?: GitHubUserUpdateOneRequiredInput;
}

export class GitHubReviewRequestUpdateInput {
    pullRequest?: GitHubPullRequestUpdateOneRequiredInput;
    requestedReviewer?: GitHubUserUpdateOneRequiredInput;
}

export class GitHubReviewRequestUpdateManyInput {
    create?: GitHubReviewRequestCreateInput[];
    connect?: GitHubReviewRequestWhereUniqueInput[];
...
export class GitHubReviewRequestUpdateWithWhereUniqueNestedInput {
    where: GitHubReviewRequestWhereUniqueInput;
    data: GitHubReviewRequestUpdateDataInput;
}

export class GitHubReviewRequestUpsertWithWhereUniqueNestedInput {
    where: GitHubReviewRequestWhereUniqueInput;
    update: GitHubReviewRequestUpdateDataInput;
    create: GitHubReviewRequestCreateInput;
}

export class GitHubReviewRequestWhereInput {
...
export class GitHubReviewRequestWhereUniqueInput {
    id?: string;
}

export class GitHubReviewThreadCreateInput {
    id?: string;
    isResolved: boolean;
    comments?: GitHubCommentCreateManyInput;
    pullRequest: GitHubPullRequestCreateOneInput;
...
export class GitHubReviewThreadCreateManyInput {
    create?: GitHubReviewThreadCreateInput[];
    connect?: GitHubReviewThreadWhereUniqueInput[];
}

export class GitHubReviewThreadScalarWhereInput {
...
export class GitHubReviewThreadSubscriptionWhereInput {
...
export class GitHubReviewThreadUpdateDataInput {
    isResolved?: boolean;
    comments?: GitHubCommentUpdateManyInput;
    pullRequest?: GitHubPullRequestUpdateOneRequiredInput;
...
export class GitHubReviewThreadUpdateInput {
    isResolved?: boolean;
    comments?: GitHubCommentUpdateManyInput;
    pullRequest?: GitHubPullRequestUpdateOneRequiredInput;
    repository?: GitHubRepositoryUpdateOneRequiredInput;
...
export class GitHubReviewThreadUpdateManyDataInput {
    isResolved?: boolean;
}

export class GitHubReviewThreadUpdateManyInput {
    create?: GitHubReviewThreadCreateInput[];
    connect?: GitHubReviewThreadWhereUniqueInput[];
...
export class GitHubReviewThreadUpdateManyMutationInput {
    isResolved?: boolean;
}

export class GitHubReviewThreadUpdateManyWithWhereNestedInput {
    where: GitHubReviewThreadScalarWhereInput;
    data: GitHubReviewThreadUpdateManyDataInput;
}

export class GitHubReviewThreadUpdateWithWhereUniqueNestedInput {
    where: GitHubReviewThreadWhereUniqueInput;
    data: GitHubReviewThreadUpdateDataInput;
}

export class GitHubReviewThreadUpsertWithWhereUniqueNestedInput {
    where: GitHubReviewThreadWhereUniqueInput;
    update: GitHubReviewThreadUpdateDataInput;
    create: GitHubReviewThreadCreateInput;
}

export class GitHubReviewThreadWhereInput {
...
export class GitHubReviewThreadWhereUniqueInput {
    id?: string;
}

export class GitHubTopicCreateInput {
    id?: string;
    name: string;
...
export class GitHubTopicCreateManyInput {
    create?: GitHubTopicCreateInput[];
    connect?: GitHubTopicWhereUniqueInput[];
}

export class GitHubTopicScalarWhereInput {
...
export class GitHubTopicSubscriptionWhereInput {
...
export class GitHubTopicUpdateDataInput {
    name?: string;
    relatedTopics?: GitHubTopicUpdateManyInput;
    stargazers?: GitHubUserUpdateManyInput;
}

export class GitHubTopicUpdateInput {
    name?: string;
    relatedTopics?: GitHubTopicUpdateManyInput;
    stargazers?: GitHubUserUpdateManyInput;
}

export class GitHubTopicUpdateManyDataInput {
    name?: string;
}

export class GitHubTopicUpdateManyInput {
    create?: GitHubTopicCreateInput[];
    connect?: GitHubTopicWhereUniqueInput[];
...
export class GitHubTopicUpdateManyMutationInput {
    name?: string;
}

export class GitHubTopicUpdateManyWithWhereNestedInput {
    where: GitHubTopicScalarWhereInput;
    data: GitHubTopicUpdateManyDataInput;
}

export class GitHubTopicUpdateWithWhereUniqueNestedInput {
    where: GitHubTopicWhereUniqueInput;
    data: GitHubTopicUpdateDataInput;
}

export class GitHubTopicUpsertWithWhereUniqueNestedInput {
    where: GitHubTopicWhereUniqueInput;
    update: GitHubTopicUpdateDataInput;
    create: GitHubTopicCreateInput;
}

export class GitHubTopicWhereInput {
...
export class GitHubTopicWhereUniqueInput {
    id?: string;
}

export class GitHubUserCreateInput {
    id?: string;
    url: string;
    name: string;
    login: string;
...
export class GitHubUserCreateManyInput {
    create?: GitHubUserCreateInput[];
    connect?: GitHubUserWhereUniqueInput[];
}

export class GitHubUserCreateOneInput {
    create?: GitHubUserCreateInput;
    connect?: GitHubUserWhereUniqueInput;
}

export class GitHubUserScalarWhereInput {
...
export class GitHubUserSubscriptionWhereInput {
...
export class GitHubUserUpdateDataInput {
    url?: string;
    name?: string;
    login?: string;
    avatarUrl?: string;
...
export class GitHubUserUpdateInput {
    url?: string;
    name?: string;
    login?: string;
    avatarUrl?: string;
...
export class GitHubUserUpdateManyDataInput {
    url?: string;
    name?: string;
    login?: string;
    avatarUrl?: string;
...
export class GitHubUserUpdateManyInput {
    create?: GitHubUserCreateInput[];
    connect?: GitHubUserWhereUniqueInput[];
...
export class GitHubUserUpdateManyMutationInput {
    url?: string;
    name?: string;
    login?: string;
    avatarUrl?: string;
...
export class GitHubUserUpdateManyWithWhereNestedInput {
    where: GitHubUserScalarWhereInput;
    data: GitHubUserUpdateManyDataInput;
}

export class GitHubUserUpdateOneInput {
    create?: GitHubUserCreateInput;
    connect?: GitHubUserWhereUniqueInput;
    disconnect?: boolean;
    delete?: boolean;
...
export class GitHubUserUpdateOneRequiredInput {
    create?: GitHubUserCreateInput;
    connect?: GitHubUserWhereUniqueInput;
    update?: GitHubUserUpdateDataInput;
    upsert?: GitHubUserUpsertNestedInput;
...
export class GitHubUserUpdateWithWhereUniqueNestedInput {
    where: GitHubUserWhereUniqueInput;
    data: GitHubUserUpdateDataInput;
}

export class GitHubUserUpsertNestedInput {
    update: GitHubUserUpdateDataInput;
    create: GitHubUserCreateInput;
}

export class GitHubUserUpsertWithWhereUniqueNestedInput {
    where: GitHubUserWhereUniqueInput;
    update: GitHubUserUpdateDataInput;
    create: GitHubUserCreateInput;
}

export class GitHubUserWhereInput {
...
export class GitHubUserWhereUniqueInput {
    id?: string;
}
...
export class AggregateGitHubBranch {
    count: number;
}

export class AggregateGitHubComment {
    count: number;
}

export class AggregateGitHubCommit {
    count: number;
}

export class AggregateGitHubFileDiff {
    count: number;
}

export class AggregateGitHubIssue {
    count: number;
}

export class AggregateGitHubLabel {
    count: number;
}

export class AggregateGitHubPullRequest {
    count: number;
}

export class AggregateGitHubPullRequestReview {
    count: number;
}

export class AggregateGitHubRepository {
    count: number;
}

export class AggregateGitHubReviewRequest {
    count: number;
}

export class AggregateGitHubReviewThread {
    count: number;
}

export class AggregateGitHubTopic {
    count: number;
}

export class AggregateGitHubUser {
    count: number;
}
...
export class GitHubBranch implements Node {
    id: string;
    name: string;
...
export class GitHubBranchConnection {
    pageInfo: PageInfo;
    edges: GitHubBranchEdge[];
    aggregate: AggregateGitHubBranch;
}

export class GitHubBranchEdge {
    node: GitHubBranch;
    cursor: string;
}

export class GitHubBranchPreviousValues {
    id: string;
    name: string;
    merged?: boolean;
    createdAt: DateTime;
...
export class GitHubBranchSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubBranch;
    updatedFields?: string[];
...
export class GitHubComment implements Node {
    author: GitHubUser;
    bodyText: string;
    createdAtExternal: DateTime;
    id: string;
...
export class GitHubCommentConnection {
    pageInfo: PageInfo;
    edges: GitHubCommentEdge[];
    aggregate: AggregateGitHubComment;
}

export class GitHubCommentEdge {
    node: GitHubComment;
    cursor: string;
}

export class GitHubCommentPreviousValues {
    bodyText: string;
    createdAtExternal: DateTime;
    id: string;
    url: string;
...
export class GitHubCommentSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubComment;
    updatedFields?: string[];
...
export class GitHubCommit implements Node {
    additions: number;
...
export class GitHubCommitConnection {
    pageInfo: PageInfo;
    edges: GitHubCommitEdge[];
    aggregate: AggregateGitHubCommit;
}

export class GitHubCommitEdge {
    node: GitHubCommit;
    cursor: string;
}

export class GitHubCommitPreviousValues {
    additions: number;
    authedDate: DateTime;
    changedFiles: number;
    commitUrl: string;
...
export class GitHubCommitSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubCommit;
    updatedFields?: string[];
...
export class GitHubFileDiff implements Node {
    id: string;
    additions: number;
    deletions: number;
    filepath: string;
...
export class GitHubFileDiffConnection {
    pageInfo: PageInfo;
    edges: GitHubFileDiffEdge[];
    aggregate: AggregateGitHubFileDiff;
}

export class GitHubFileDiffEdge {
    node: GitHubFileDiff;
    cursor: string;
}

export class GitHubFileDiffPreviousValues {
    id: string;
    additions: number;
    deletions: number;
    filepath: string;
...
export class GitHubFileDiffSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubFileDiff;
    updatedFields?: string[];
...
export class GitHubIssue implements Node {
    id: string;
...
export class GitHubIssueConnection {
    pageInfo: PageInfo;
    edges: GitHubIssueEdge[];
    aggregate: AggregateGitHubIssue;
}

export class GitHubIssueEdge {
    node: GitHubIssue;
    cursor: string;
}

export class GitHubIssuePreviousValues {
    id: string;
    bodyText: string;
    closed?: DateTime;
    createdAtExternal: DateTime;
...
export class GitHubIssueSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubIssue;
    updatedFields?: string[];
...
export class GitHubLabel implements Node {
    id: string;
    color: string;
    createdAtExternal: DateTime;
    description: string;
...
export class GitHubLabelConnection {
    pageInfo: PageInfo;
    edges: GitHubLabelEdge[];
    aggregate: AggregateGitHubLabel;
}

export class GitHubLabelEdge {
    node: GitHubLabel;
    cursor: string;
}

export class GitHubLabelPreviousValues {
    id: string;
    color: string;
    createdAtExternal: DateTime;
    description: string;
...
export class GitHubLabelSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubLabel;
    updatedFields?: string[];
...
export class GitHubPullRequest implements Node {
    additions: number;
    assignees?: GitHubUser[];
    author: GitHubUser;
    bodyText: string;
...
export class GitHubPullRequestConnection {
    pageInfo: PageInfo;
    edges: GitHubPullRequestEdge[];
    aggregate: AggregateGitHubPullRequest;
}

export class GitHubPullRequestEdge {
    node: GitHubPullRequest;
    cursor: string;
}

export class GitHubPullRequestPreviousValues {
    additions: number;
    bodyText: string;
    changedFiles: number;
    closed: boolean;
...
export class GitHubPullRequestReview implements Node {
    author: GitHubUser;
    bodyText: string;
    comments?: GitHubComment[];
    commit?: GitHubCommit[];
...
export class GitHubPullRequestReviewConnection {
    pageInfo: PageInfo;
    edges: GitHubPullRequestReviewEdge[];
    aggregate: AggregateGitHubPullRequestReview;
}

export class GitHubPullRequestReviewEdge {
    node: GitHubPullRequestReview;
    cursor: string;
}

export class GitHubPullRequestReviewPreviousValues {
    bodyText: string;
    createdAtExternal: DateTime;
    id: string;
    lastEditeddAt: DateTime;
...
export class GitHubPullRequestReviewSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubPullRequestReview;
    updatedFields?: string[];
...
export class GitHubPullRequestSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubPullRequest;
    updatedFields?: string[];
...
export class GitHubRepository implements Node {
...
export class GitHubRepositoryConnection {
    pageInfo: PageInfo;
    edges: GitHubRepositoryEdge[];
    aggregate: AggregateGitHubRepository;
}

export class GitHubRepositoryEdge {
    node: GitHubRepository;
    cursor: string;
}

export class GitHubRepositoryPreviousValues {
    description: string;
    hasBranchRules: boolean;
    hasContributingGuidelines: boolean;
    hasPullRequestTemplate: boolean;
...
export class GitHubRepositorySubscriptionPayload {
    mutation: MutationType;
    node?: GitHubRepository;
    updatedFields?: string[];
...
export class GitHubReviewRequest implements Node {
    id: string;
    pullRequest: GitHubPullRequest;
...
export class GitHubReviewRequestConnection {
    pageInfo: PageInfo;
    edges: GitHubReviewRequestEdge[];
    aggregate: AggregateGitHubReviewRequest;
}

export class GitHubReviewRequestEdge {
    node: GitHubReviewRequest;
    cursor: string;
}

export class GitHubReviewRequestPreviousValues {
    id: string;
    createdAt: DateTime;
    updatedAt: DateTime;
}

export class GitHubReviewRequestSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubReviewRequest;
    updatedFields?: string[];
...
export class GitHubReviewThread implements Node {
    comments?: GitHubComment[];
    id: string;
    isResolved: boolean;
    pullRequest: GitHubPullRequest;
...
export class GitHubReviewThreadConnection {
    pageInfo: PageInfo;
    edges: GitHubReviewThreadEdge[];
    aggregate: AggregateGitHubReviewThread;
}

export class GitHubReviewThreadEdge {
    node: GitHubReviewThread;
    cursor: string;
}

export class GitHubReviewThreadPreviousValues {
    id: string;
    isResolved: boolean;
    createdAt: DateTime;
    updatedAt: DateTime;
...
export class GitHubReviewThreadSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubReviewThread;
    updatedFields?: string[];
...
export class GitHubTopic implements Node {
    id: string;
    name: string;
...
export class GitHubTopicConnection {
    pageInfo: PageInfo;
    edges: GitHubTopicEdge[];
    aggregate: AggregateGitHubTopic;
}

export class GitHubTopicEdge {
    node: GitHubTopic;
    cursor: string;
}

export class GitHubTopicPreviousValues {
    id: string;
    name: string;
    createdAt: DateTime;
    updatedAt: DateTime;
...
export class GitHubTopicSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubTopic;
    updatedFields?: string[];
...
export class GitHubUser implements Node {
    id: string;
    url: string;
    name: string;
    login: string;
...
export class GitHubUserEdge {
    node: GitHubUser;
    cursor: string;
}

export class GitHubUserPreviousValues {
    id: string;
    url: string;
    name: string;
    login: string;
...
export class GitHubUserSubscriptionPayload {
    mutation: MutationType;
    node?: GitHubUser;
    updatedFields?: string[];
...
export abstract class IMutation {
    ...
    abstract createGitHubBranch(data: GitHubBranchCreateInput): GitHubBranch | Promise<GitHubBranch>;
    abstract createGitHubReviewThread(data: GitHubReviewThreadCreateInput): GitHubReviewThread | Promise<GitHubReviewThread>;
    abstract createGitHubPullRequestReview(data: GitHubPullRequestReviewCreateInput): GitHubPullRequestReview | Promise<GitHubPullRequestReview>;
    abstract createGitHubComment(data: GitHubCommentCreateInput): GitHubComment | Promise<GitHubComment>;
    abstract createGitHubReviewRequest(data: GitHubReviewRequestCreateInput): GitHubReviewRequest | Promise<GitHubReviewRequest>;
    abstract createGitHubTopic(data: GitHubTopicCreateInput): GitHubTopic | Promise<GitHubTopic>;
    abstract createGitHubIssue(data: GitHubIssueCreateInput): GitHubIssue | Promise<GitHubIssue>;
    abstract createGitHubRepository(data: GitHubRepositoryCreateInput): GitHubRepository | Promise<GitHubRepository>;
    abstract createGitHubPullRequest(data: GitHubPullRequestCreateInput): GitHubPullRequest | Promise<GitHubPullRequest>;
    abstract createGitHubCommit(data: GitHubCommitCreateInput): GitHubCommit | Promise<GitHubCommit>;
    abstract createGitHubUser(data: GitHubUserCreateInput): GitHubUser | Promise<GitHubUser>;
    abstract createGitHubFileDiff(data: GitHubFileDiffCreateInput): GitHubFileDiff | Promise<GitHubFileDiff>;
    abstract createGitHubLabel(data: GitHubLabelCreateInput): GitHubLabel | Promise<GitHubLabel>;
    ...
    abstract updateGitHubBranch(data: GitHubBranchUpdateInput, where: GitHubBranchWhereUniqueInput): GitHubBranch | Promise<GitHubBranch>;
    abstract updateGitHubReviewThread(data: GitHubReviewThreadUpdateInput, where: GitHubReviewThreadWhereUniqueInput): GitHubReviewThread | Promise<GitHubReviewThread>;
    abstract updateGitHubPullRequestReview(data: GitHubPullRequestReviewUpdateInput, where: GitHubPullRequestReviewWhereUniqueInput): GitHubPullRequestReview | Promise<GitHubPullRequestReview>;
    abstract updateGitHubComment(data: GitHubCommentUpdateInput, where: GitHubCommentWhereUniqueInput): GitHubComment | Promise<GitHubComment>;
    abstract updateGitHubReviewRequest(data: GitHubReviewRequestUpdateInput, where: GitHubReviewRequestWhereUniqueInput): GitHubReviewRequest | Promise<GitHubReviewRequest>;
    abstract updateGitHubTopic(data: GitHubTopicUpdateInput, where: GitHubTopicWhereUniqueInput): GitHubTopic | Promise<GitHubTopic>;
    abstract updateGitHubIssue(data: GitHubIssueUpdateInput, where: GitHubIssueWhereUniqueInput): GitHubIssue | Promise<GitHubIssue>;
    abstract updateGitHubRepository(data: GitHubRepositoryUpdateInput, where: GitHubRepositoryWhereUniqueInput): GitHubRepository | Promise<GitHubRepository>;
    abstract updateGitHubPullRequest(data: GitHubPullRequestUpdateInput, where: GitHubPullRequestWhereUniqueInput): GitHubPullRequest | Promise<GitHubPullRequest>;
    abstract updateGitHubCommit(data: GitHubCommitUpdateInput, where: GitHubCommitWhereUniqueInput): GitHubCommit | Promise<GitHubCommit>;
    abstract updateGitHubUser(data: GitHubUserUpdateInput, where: GitHubUserWhereUniqueInput): GitHubUser | Promise<GitHubUser>;
    abstract updateGitHubFileDiff(data: GitHubFileDiffUpdateInput, where: GitHubFileDiffWhereUniqueInput): GitHubFileDiff | Promise<GitHubFileDiff>;
    abstract updateGitHubLabel(data: GitHubLabelUpdateInput, where: GitHubLabelWhereUniqueInput): GitHubLabel | Promise<GitHubLabel>;
    ...
    abstract deleteGitHubBranch(where: GitHubBranchWhereUniqueInput): GitHubBranch | Promise<GitHubBranch>;
    abstract deleteGitHubReviewThread(where: GitHubReviewThreadWhereUniqueInput): GitHubReviewThread | Promise<GitHubReviewThread>;
    abstract deleteGitHubPullRequestReview(where: GitHubPullRequestReviewWhereUniqueInput): GitHubPullRequestReview | Promise<GitHubPullRequestReview>;
    abstract deleteGitHubComment(where: GitHubCommentWhereUniqueInput): GitHubComment | Promise<GitHubComment>;
    abstract deleteGitHubReviewRequest(where: GitHubReviewRequestWhereUniqueInput): GitHubReviewRequest | Promise<GitHubReviewRequest>;
    abstract deleteGitHubTopic(where: GitHubTopicWhereUniqueInput): GitHubTopic | Promise<GitHubTopic>;
    abstract deleteGitHubIssue(where: GitHubIssueWhereUniqueInput): GitHubIssue | Promise<GitHubIssue>;
    abstract deleteGitHubRepository(where: GitHubRepositoryWhereUniqueInput): GitHubRepository | Promise<GitHubRepository>;
    abstract deleteGitHubPullRequest(where: GitHubPullRequestWhereUniqueInput): GitHubPullRequest | Promise<GitHubPullRequest>;
    abstract deleteGitHubCommit(where: GitHubCommitWhereUniqueInput): GitHubCommit | Promise<GitHubCommit>;
    abstract deleteGitHubUser(where: GitHubUserWhereUniqueInput): GitHubUser | Promise<GitHubUser>;
    abstract deleteGitHubFileDiff(where: GitHubFileDiffWhereUniqueInput): GitHubFileDiff | Promise<GitHubFileDiff>;
    abstract deleteGitHubLabel(where: GitHubLabelWhereUniqueInput): GitHubLabel | Promise<GitHubLabel>;
    ...
    abstract upsertGitHubBranch(where: GitHubBranchWhereUniqueInput, create: GitHubBranchCreateInput, update: GitHubBranchUpdateInput): GitHubBranch | Promise<GitHubBranch>;
    abstract upsertGitHubReviewThread(where: GitHubReviewThreadWhereUniqueInput, create: GitHubReviewThreadCreateInput, update: GitHubReviewThreadUpdateInput): GitHubReviewThread | Promise<GitHubReviewThread>;
    abstract upsertGitHubPullRequestReview(where: GitHubPullRequestReviewWhereUniqueInput, create: GitHubPullRequestReviewCreateInput, update: GitHubPullRequestReviewUpdateInput): GitHubPullRequestReview | Promise<GitHubPullRequestReview>;
    abstract upsertGitHubComment(where: GitHubCommentWhereUniqueInput, create: GitHubCommentCreateInput, update: GitHubCommentUpdateInput): GitHubComment | Promise<GitHubComment>;
    abstract upsertGitHubReviewRequest(where: GitHubReviewRequestWhereUniqueInput, create: GitHubReviewRequestCreateInput, update: GitHubReviewRequestUpdateInput): GitHubReviewRequest | Promise<GitHubReviewRequest>;
    abstract upsertGitHubTopic(where: GitHubTopicWhereUniqueInput, create: GitHubTopicCreateInput, update: GitHubTopicUpdateInput): GitHubTopic | Promise<GitHubTopic>;
    abstract upsertGitHubIssue(where: GitHubIssueWhereUniqueInput, create: GitHubIssueCreateInput, update: GitHubIssueUpdateInput): GitHubIssue | Promise<GitHubIssue>;
    abstract upsertGitHubRepository(where: GitHubRepositoryWhereUniqueInput, create: GitHubRepositoryCreateInput, update: GitHubRepositoryUpdateInput): GitHubRepository | Promise<GitHubRepository>;
    abstract upsertGitHubPullRequest(where: GitHubPullRequestWhereUniqueInput, create: GitHubPullRequestCreateInput, update: GitHubPullRequestUpdateInput): GitHubPullRequest | Promise<GitHubPullRequest>;
    abstract upsertGitHubCommit(where: GitHubCommitWhereUniqueInput, create: GitHubCommitCreateInput, update: GitHubCommitUpdateInput): GitHubCommit | Promise<GitHubCommit>;
    abstract upsertGitHubUser(where: GitHubUserWhereUniqueInput, create: GitHubUserCreateInput, update: GitHubUserUpdateInput): GitHubUser | Promise<GitHubUser>;
    abstract upsertGitHubFileDiff(where: GitHubFileDiffWhereUniqueInput, create: GitHubFileDiffCreateInput, update: GitHubFileDiffUpdateInput): GitHubFileDiff | Promise<GitHubFileDiff>;
    abstract upsertGitHubLabel(where: GitHubLabelWhereUniqueInput, create: GitHubLabelCreateInput, update: GitHubLabelUpdateInput): GitHubLabel | Promise<GitHubLabel>;
    ...
    abstract updateManyGitHubBranches(data: GitHubBranchUpdateManyMutationInput, where?: GitHubBranchWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubReviewThreads(data: GitHubReviewThreadUpdateManyMutationInput, where?: GitHubReviewThreadWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubPullRequestReviews(data: GitHubPullRequestReviewUpdateManyMutationInput, where?: GitHubPullRequestReviewWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubComments(data: GitHubCommentUpdateManyMutationInput, where?: GitHubCommentWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubTopics(data: GitHubTopicUpdateManyMutationInput, where?: GitHubTopicWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubIssues(data: GitHubIssueUpdateManyMutationInput, where?: GitHubIssueWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubRepositories(data: GitHubRepositoryUpdateManyMutationInput, where?: GitHubRepositoryWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubPullRequests(data: GitHubPullRequestUpdateManyMutationInput, where?: GitHubPullRequestWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubCommits(data: GitHubCommitUpdateManyMutationInput, where?: GitHubCommitWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubUsers(data: GitHubUserUpdateManyMutationInput, where?: GitHubUserWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubFileDiffs(data: GitHubFileDiffUpdateManyMutationInput, where?: GitHubFileDiffWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract updateManyGitHubLabels(data: GitHubLabelUpdateManyMutationInput, where?: GitHubLabelWhereInput): BatchPayload | Promise<BatchPayload>;
    ...
    abstract deleteManyGitHubBranches(where?: GitHubBranchWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubReviewThreads(where?: GitHubReviewThreadWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubPullRequestReviews(where?: GitHubPullRequestReviewWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubComments(where?: GitHubCommentWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubReviewRequests(where?: GitHubReviewRequestWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubTopics(where?: GitHubTopicWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubIssues(where?: GitHubIssueWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubRepositories(where?: GitHubRepositoryWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubPullRequests(where?: GitHubPullRequestWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubCommits(where?: GitHubCommitWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubUsers(where?: GitHubUserWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubFileDiffs(where?: GitHubFileDiffWhereInput): BatchPayload | Promise<BatchPayload>;
    abstract deleteManyGitHubLabels(where?: GitHubLabelWhereInput): BatchPayload | Promise<BatchPayload>;
...
export abstract class IQuery {
    ...
    abstract gitHubBranches(where?: GitHubBranchWhereInput, orderBy?: GitHubBranchOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubBranch[] | Promise<GitHubBranch[]>;
    abstract gitHubReviewThreads(where?: GitHubReviewThreadWhereInput, orderBy?: GitHubReviewThreadOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubReviewThread[] | Promise<GitHubReviewThread[]>;
    abstract gitHubPullRequestReviews(where?: GitHubPullRequestReviewWhereInput, orderBy?: GitHubPullRequestReviewOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubPullRequestReview[] | Promise<GitHubPullRequestReview[]>;
    abstract gitHubComments(where?: GitHubCommentWhereInput, orderBy?: GitHubCommentOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubComment[] | Promise<GitHubComment[]>;
    abstract gitHubReviewRequests(where?: GitHubReviewRequestWhereInput, orderBy?: GitHubReviewRequestOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubReviewRequest[] | Promise<GitHubReviewRequest[]>;
    abstract gitHubTopics(where?: GitHubTopicWhereInput, orderBy?: GitHubTopicOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubTopic[] | Promise<GitHubTopic[]>;
    abstract gitHubIssues(where?: GitHubIssueWhereInput, orderBy?: GitHubIssueOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubIssue[] | Promise<GitHubIssue[]>;
    abstract gitHubRepositories(where?: GitHubRepositoryWhereInput, orderBy?: GitHubRepositoryOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubRepository[] | Promise<GitHubRepository[]>;
    abstract gitHubPullRequests(where?: GitHubPullRequestWhereInput, orderBy?: GitHubPullRequestOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubPullRequest[] | Promise<GitHubPullRequest[]>;
    abstract gitHubCommits(where?: GitHubCommitWhereInput, orderBy?: GitHubCommitOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubCommit[] | Promise<GitHubCommit[]>;
    abstract gitHubUsers(where?: GitHubUserWhereInput, orderBy?: GitHubUserOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubUser[] | Promise<GitHubUser[]>;
    abstract gitHubFileDiffs(where?: GitHubFileDiffWhereInput, orderBy?: GitHubFileDiffOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubFileDiff[] | Promise<GitHubFileDiff[]>;
    abstract gitHubLabels(where?: GitHubLabelWhereInput, orderBy?: GitHubLabelOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubLabel[] | Promise<GitHubLabel[]>;
    ...
    abstract gitHubBranch(where: GitHubBranchWhereUniqueInput): GitHubBranch | Promise<GitHubBranch>;
    abstract gitHubReviewThread(where: GitHubReviewThreadWhereUniqueInput): GitHubReviewThread | Promise<GitHubReviewThread>;
    abstract gitHubPullRequestReview(where: GitHubPullRequestReviewWhereUniqueInput): GitHubPullRequestReview | Promise<GitHubPullRequestReview>;
    abstract gitHubComment(where: GitHubCommentWhereUniqueInput): GitHubComment | Promise<GitHubComment>;
    abstract gitHubReviewRequest(where: GitHubReviewRequestWhereUniqueInput): GitHubReviewRequest | Promise<GitHubReviewRequest>;
    abstract gitHubTopic(where: GitHubTopicWhereUniqueInput): GitHubTopic | Promise<GitHubTopic>;
    abstract gitHubIssue(where: GitHubIssueWhereUniqueInput): GitHubIssue | Promise<GitHubIssue>;
    abstract gitHubRepository(where: GitHubRepositoryWhereUniqueInput): GitHubRepository | Promise<GitHubRepository>;
    abstract gitHubPullRequest(where: GitHubPullRequestWhereUniqueInput): GitHubPullRequest | Promise<GitHubPullRequest>;
    abstract gitHubCommit(where: GitHubCommitWhereUniqueInput): GitHubCommit | Promise<GitHubCommit>;
    abstract gitHubUser(where: GitHubUserWhereUniqueInput): GitHubUser | Promise<GitHubUser>;
    abstract gitHubFileDiff(where: GitHubFileDiffWhereUniqueInput): GitHubFileDiff | Promise<GitHubFileDiff>;
    abstract gitHubLabel(where: GitHubLabelWhereUniqueInput): GitHubLabel | Promise<GitHubLabel>;
    ...
    abstract gitHubBranchesConnection(where?: GitHubBranchWhereInput, orderBy?: GitHubBranchOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubBranchConnection | Promise<GitHubBranchConnection>;
    abstract gitHubReviewThreadsConnection(where?: GitHubReviewThreadWhereInput, orderBy?: GitHubReviewThreadOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubReviewThreadConnection | Promise<GitHubReviewThreadConnection>;
    abstract gitHubPullRequestReviewsConnection(where?: GitHubPullRequestReviewWhereInput, orderBy?: GitHubPullRequestReviewOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubPullRequestReviewConnection | Promise<GitHubPullRequestReviewConnection>;
    abstract gitHubCommentsConnection(where?: GitHubCommentWhereInput, orderBy?: GitHubCommentOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubCommentConnection | Promise<GitHubCommentConnection>;
    abstract gitHubReviewRequestsConnection(where?: GitHubReviewRequestWhereInput, orderBy?: GitHubReviewRequestOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubReviewRequestConnection | Promise<GitHubReviewRequestConnection>;
    abstract gitHubTopicsConnection(where?: GitHubTopicWhereInput, orderBy?: GitHubTopicOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubTopicConnection | Promise<GitHubTopicConnection>;
    abstract gitHubIssuesConnection(where?: GitHubIssueWhereInput, orderBy?: GitHubIssueOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubIssueConnection | Promise<GitHubIssueConnection>;
    abstract gitHubRepositoriesConnection(where?: GitHubRepositoryWhereInput, orderBy?: GitHubRepositoryOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubRepositoryConnection | Promise<GitHubRepositoryConnection>;
    abstract gitHubPullRequestsConnection(where?: GitHubPullRequestWhereInput, orderBy?: GitHubPullRequestOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubPullRequestConnection | Promise<GitHubPullRequestConnection>;
    abstract gitHubCommitsConnection(where?: GitHubCommitWhereInput, orderBy?: GitHubCommitOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubCommitConnection | Promise<GitHubCommitConnection>;
    abstract gitHubUsersConnection(where?: GitHubUserWhereInput, orderBy?: GitHubUserOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubUserConnection | Promise<GitHubUserConnection>;
    abstract gitHubFileDiffsConnection(where?: GitHubFileDiffWhereInput, orderBy?: GitHubFileDiffOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubFileDiffConnection | Promise<GitHubFileDiffConnection>;
    abstract gitHubLabelsConnection(where?: GitHubLabelWhereInput, orderBy?: GitHubLabelOrderByInput, skip?: number, after?: string, before?: string, first?: number, last?: number): GitHubLabelConnection | Promise<GitHubLabelConnection>;
...
export abstract class ISubscription {
    ...
    abstract gitHubBranch(where?: GitHubBranchSubscriptionWhereInput): GitHubBranchSubscriptionPayload | Promise<GitHubBranchSubscriptionPayload>;
    abstract gitHubReviewThread(where?: GitHubReviewThreadSubscriptionWhereInput): GitHubReviewThreadSubscriptionPayload | Promise<GitHubReviewThreadSubscriptionPayload>;
    abstract gitHubPullRequestReview(where?: GitHubPullRequestReviewSubscriptionWhereInput): GitHubPullRequestReviewSubscriptionPayload | Promise<GitHubPullRequestReviewSubscriptionPayload>;
    abstract gitHubComment(where?: GitHubCommentSubscriptionWhereInput): GitHubCommentSubscriptionPayload | Promise<GitHubCommentSubscriptionPayload>;
    abstract gitHubReviewRequest(where?: GitHubReviewRequestSubscriptionWhereInput): GitHubReviewRequestSubscriptionPayload | Promise<GitHubReviewRequestSubscriptionPayload>;
    abstract gitHubTopic(where?: GitHubTopicSubscriptionWhereInput): GitHubTopicSubscriptionPayload | Promise<GitHubTopicSubscriptionPayload>;
    abstract gitHubIssue(where?: GitHubIssueSubscriptionWhereInput): GitHubIssueSubscriptionPayload | Promise<GitHubIssueSubscriptionPayload>;
    abstract gitHubRepository(where?: GitHubRepositorySubscriptionWhereInput): GitHubRepositorySubscriptionPayload | Promise<GitHubRepositorySubscriptionPayload>;
    abstract gitHubPullRequest(where?: GitHubPullRequestSubscriptionWhereInput): GitHubPullRequestSubscriptionPayload | Promise<GitHubPullRequestSubscriptionPayload>;
    abstract gitHubCommit(where?: GitHubCommitSubscriptionWhereInput): GitHubCommitSubscriptionPayload | Promise<GitHubCommitSubscriptionPayload>;
    abstract gitHubUser(where?: GitHubUserSubscriptionWhereInput): GitHubUserSubscriptionPayload | Promise<GitHubUserSubscriptionPayload>;
    abstract gitHubFileDiff(where?: GitHubFileDiffSubscriptionWhereInput): GitHubFileDiffSubscriptionPayload | Promise<GitHubFileDiffSubscriptionPayload>;
    abstract gitHubLabel(where?: GitHubLabelSubscriptionWhereInput): GitHubLabelSubscriptionPayload | Promise<GitHubLabelSubscriptionPayload>;
}
