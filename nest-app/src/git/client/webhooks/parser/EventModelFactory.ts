...
export class EventModelFactory {
    ...
    public static makeModel(
        ...
        switch (eventType) {
            case GitHubWebhookEvents.CheckRun:
                return plainToClass(
                    EventModelFactory.getModelConstructor(eventType),
                    params
                );
    ...
    public static getModelConstructor(
        eventType: CommitComment
    ): new () => CommitCommentEvent;
    public static getModelConstructor(
        eventType: ContentReference
    ): new () => ContentReferenceEvent;
    ...
    public static getModelConstructor(
        ...
        switch (eventType) {
            ...
            default:
                throw new Error(
                    `GitHub Webhook Event Type Not Found ${eventType}`
                );
        }
    }
}
