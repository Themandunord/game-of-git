...
import { purgeUsers, signupMutationFactory } from '../../testUtils/user';
...
const INVALID_VALIDATION_SCENARIOS = [
    ...
    },
    {
        ...
        errorTextContains: `Field SignupInput.name of required type String! was not provided.`
    },
    {
        it: `gitLogin is missing`,
        mutation: signupMutationFactory({
            ...USER_BASE,
            gitLogin: undefined
        }),
        errorTextContains: `Field SignupInput.gitLogin of required type String! was not provided.`
    }
];
